...
def get_quantitative_analysis(tickerSymbol, expiration_date, option_style, option_type, data_source, itm_atm_otm):
    ...
    return {
        "variables": {
            "risk_free_rate_r": round(riskFreeRate, 2),
        ...
        "valuations": {
            "black_scholes": round(valuation.blackScholes(), 2),
...
def get_fundamental_analysis(ticker, data_source):
    ...
    return {
        ...
        "metrics": {
            "fair_value": fundamental.get_priceFairValueTTM(),
