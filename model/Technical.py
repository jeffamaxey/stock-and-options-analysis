...
class Technical:
    ...
    def __init__(self, ticker):
        ...
        # set end time to be the current date
    ...
    def set_simple_moving_average_range_30_10(self):
        ...
        simple_moving_average_30_day = round(float(TA.SMA(self.ohlc, 30).values[-1], ),
                                             2)  # convert simple 30 day moving average to float and round to 2
        # decimal places
        simple_moving_average_10_day = round(float(TA.SMA(self.ohlc, 10).values[-1], ),
                                             2)  # convert simple 10 day moving average to float and round to 2
        # decimal places
