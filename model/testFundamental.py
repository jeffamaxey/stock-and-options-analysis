...
def main():
    ...
    if stock1.get_priceFairValueTTM() != 31.04:
        print("Error: AAPL stock get_priceFairValueTTM() method is incorrect and does not equal 31.04 as shown in sec.gov, "
    ...
    if stock1.get_priceToBookRatioTTM() != 31.04:
        print("Error: AAPL stock get_priceToBookRatioTTM() method is incorrect and does not equal 31.04 as shown in sec.gov, "
    ...
    if stock1.get_priceFairValueTTM() != 7.35:
        print("Error: PRTS stock get_priceFairValueTTM() method is incorrect and does not equal 7.35 as shown in sec.gov, "
              "current value is " + str(stock1.get_priceFairValueTTM()))
    ...
    if stock1.get_priceToBookRatioTTM() != 7.35:
        print("Error: PRTS stock get_priceToBookRatioTTM() method is incorrect and does not equal 7.35 as shown in sec.gov, "
              "current value is " + str(stock1.get_priceToBookRatioTTM()))
    ...
    if stock1.get_priceEarningsToGrowthRatioTTM() != 13.84:
        print("Error: PRTS stock get_priceEarningsToGrowthRatioTTM() method is incorrect and does not equal 13.84 as shown in sec.gov, "
              "current value is " + str(stock1.get_priceEarningsToGrowthRatioTTM()))
    ...
    if stock1.get_priceFairValueTTM() != 4.47:
        print("Error: CCMP stock get_priceFairValueTTM() method is incorrect and does not equal 4.47 as shown in sec.gov, "
              "current value is " + str(stock1.get_priceFairValueTTM()))
    ...
    if stock1.get_priceToBookRatioTTM() != 4.47:
        print(
            "Error: CCMP stock get_priceToBookRatioTTM() method is incorrect and does not equal 4.47 as shown in sec.gov, "
            "current value is " + str(stock1.get_priceToBookRatioTTM()))
