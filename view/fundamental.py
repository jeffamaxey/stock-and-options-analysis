...
__fundamental_analysis_data = []  # using a list instead of variable since it is mutable in a function
...
def fundamental_analysis():
    if request.method == "POST":
        ticker = read_field(("ticker-of-the-underlying-16", "ticker-of-the-underlying-116",
                             "ticker-of-the-underlying-126", "ticker-of-the-underlying-136"))
        data_source = read_field(("data-source16", "data-source116", "option-style130", "data-source126"))
        ...
        if analysis is None:
            ...
            __fundamental_analysis_data.insert(0, analysis)
...
def fundamental_analysis_result():
    ...
    if request.method == "POST":
        ...
        data_source = read_field(("data-source110", "data-source120", "option-style140", "data-source130"))
    ...
    try:
        analysis = __fundamental_analysis_data[0]
    ...
    __fundamental_analysis_data.clear()
