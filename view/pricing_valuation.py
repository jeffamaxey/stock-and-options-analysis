...
def pricing_valuation():
    ...
    return render_template("pricing-and-valuation-page.html", user=current_user,
                           # field values
                           expiration_date1=expiration_date_list[0],
                           expiration_date2=expiration_date_list[1],
                           expiration_date3=expiration_date_list[2],
                           expiration_date4=expiration_date_list[3],
                           expiration_date5=expiration_date_list[4],
                           expiration_date6=expiration_date_list[5],
                           expiration_date7=expiration_date_list[6],
                           expiration_date8=expiration_date_list[7],
                           expiration_date9=expiration_date_list[8],
                           expiration_date10=expiration_date_list[9],
                           expiration_date11=expiration_date_list[10],
                           expiration_date12=expiration_date_list[11],
                           expiration_date13=expiration_date_list[12],
                           expiration_date14=expiration_date_list[13],
                           expiration_date15=expiration_date_list[14],
                           expiration_date16=expiration_date_list[15],

                           option_type1=option_type_list[0],
                           option_type2=option_type_list[1],

                           option_style1=option_style_list[0],
                           option_style2=option_style_list[1],

                           data_source1=data_source_list[0],
                           data_source2=data_source_list[1],

                           itm_atm_otm1=itm_atm_otm_list[0],
                           itm_atm_otm2=itm_atm_otm_list[1],
                           itm_atm_otm3=itm_atm_otm_list[2],
                           itm_atm_otm4=itm_atm_otm_list[3],
                           itm_atm_otm5=itm_atm_otm_list[4]
                           )
